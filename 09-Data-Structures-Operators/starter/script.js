...
// Real life example with the optional chaining operator
// const users = [
//   { name: 'Imanuel', age: 30 },
//   { name: 'Jonas', age: 25 },
//   { name: 'Jona', age: 20 },
...
// console.log(users[0]?.age ?? 'No age');
// console.log(users[3]?.age ?? 'No age');

// TODO: Small project: Based on users input change another value or delete, using short circuiting and optional chaining. Save every input in an object
const userInput1 = prompt('Enter a number between 1-100');
const userInput2 = prompt('Enter a number between 1-100');
const userInput3 = prompt('Enter a number between 1-100');
const userInput4 = prompt('Enter a number between 1-100');
const userInput5 = prompt('Enter a number between 1-100');
...
const totalUserInputs =
  userInputObject?.number1 +
  userInputObject?.number2 +
  userInputObject?.number3 +
  userInputObject?.number4 +
  userInputObject?.number5;
console.log(totalUserInputs);

delete userInputObject.number1;
const entries = Object.entries(userInputObject);
console.log(entries);
